...
available_symbols = requests.get(f'https://financialmodelingprep.com/api/v3/company/stock/list')
...
while True:
    try:
        ...
        def enterprisevalues(quote):
            ...
            enterprise_values = requests.get(f'https://financialmodelingprep.com/api/v3/enterprise-value/{quote}')
        ...
        def keymetrics(quote):
            ...
            #receive the balance sheet on an annual basis from the API financialmodelingprep
            key_metrics = requests.get(f'https://financialmodelingprep.com/api/v3/company-key-metrics/{quote}')
        ...
        def balancesheet(quote):
            ...
            #receive the balance sheet on an annual basis from the API financialmodelingprep
            annual_balancesheet = requests.get(f'https://financialmodelingprep.com/api/v3/financials/balance-sheet-statement/{quote}')
        ...
        def incomestatement(quote):
            ...
            annual_incomestatement = requests.get(f'https://financialmodelingprep.com/api/v3/financials/income-statement/{quote}')
        ...
        def cashflowstatement(quote):
            ...
            annual_cashflowstatement = requests.get(f'https://financialmodelingprep.com/api/v3/financials/cash-flow-statement/{quote}')
        ...
        def historicprices(quote):
            ...
            annual_historicprices = requests.get(f'https://financialmodelingprep.com/api/v3/company/historical-discounted-cash-flow/{quote}?period=quarter')
        ...
        def stockprice(quote):
            ...
            r = requests.get(f'https://financialmodelingprep.com/api/v3/stock/real-time-price/{quote}')
            r = r.json()
            r = r['price']
            return r
